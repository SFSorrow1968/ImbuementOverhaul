...
L "        private const string CategoryDiagnosticsDumps = ""Advanced - Dumps"";"
L ""
...
L ""
L "        [ModOption(name = OptionDumpFactions, category = CategoryDiagnosticsDumps, categoryOrder = 1000, order = 10, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
L "        public static bool DumpFactions = false;"
L "        [ModOption(name = OptionDumpWaveMap, category = CategoryDiagnosticsDumps, categoryOrder = 1000, order = 20, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
L "        public static bool DumpWaveMap = false;"
L "        [ModOption(name = OptionDumpState, category = CategoryDiagnosticsDumps, categoryOrder = 1000, order = 30, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
