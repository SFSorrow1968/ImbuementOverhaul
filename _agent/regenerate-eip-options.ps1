...
L "        private const string CategoryDiagnostics = ""Diagnostics"";"
L ""
...
L ""
L "        private const string OptionLogLevel = ""Log Level"";"
...
L "        private const string OptionDumpFactions = ""Dump Factions"";"
L "        private const string OptionDumpWaveMap = ""Dump Wave-Faction Map"";"
L "        private const string OptionDumpState = ""Dump State"";"
...
L "        [ModOption(name = OptionLogLevel, category = CategoryDiagnostics, categoryOrder = 999, order = 0, defaultValueIndex = 1, valueSourceName = nameof(LogLevelProvider))]"
L "        public static string LogLevel = ""Basic"";"
...
L ""
L "        [ModOption(name = OptionDumpFactions, category = CategoryDiagnostics, categoryOrder = 999, order = 30, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
L "        public static bool DumpFactions = false;"
L "        [ModOption(name = OptionDumpWaveMap, category = CategoryDiagnostics, categoryOrder = 999, order = 40, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
L "        public static bool DumpWaveMap = false;"
L "        [ModOption(name = OptionDumpState, category = CategoryDiagnostics, categoryOrder = 999, order = 50, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
L "        public static bool DumpState = false;"
L "        [ModOption(name = OptionForceReapply, category = CategoryDiagnostics, categoryOrder = 999, order = 60, defaultValueIndex = 0)]"
L "        [ModOptionDontSave]"
